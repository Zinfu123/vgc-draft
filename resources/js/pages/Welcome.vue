...
<template>
    ...
    <div
        class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-4 text-[#1b1b18] sm:p-6 lg:justify-center lg:p-8 dark:bg-[#0a0a0a] pb-[max(1.5rem,env(safe-area-inset-bottom,0px))] sm:pb-[max(2rem,env(safe-area-inset-bottom,0px))]"
    >
