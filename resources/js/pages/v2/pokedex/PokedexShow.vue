...
const breadcrumbs = computed<BreadcrumbItem[]>(() => [
    ...
    { title: props.pokemon.name, href: route('v2.pokedex.show', props.pokemon.id) },
]);
...
function switchVersion(slug: string) {
    router.get(route('v2.pokedex.show', props.pokemon.id), { game: slug }, { preserveScroll: true, only: ['gameData', 'selectedVersionSlug'] });
}
</script>
                        ...
                        <section class="space-y-2">
                            ...
                            <ul class="list-inside list-disc text-sm">
                                <li v-for="a in gameData.abilities" :key="a.pokeapi_ability_id + '-' + a.slot">
                                    <Link
                                        :href="route('v2.pokedex.abilities.show', a.pokeapi_ability_id)"
