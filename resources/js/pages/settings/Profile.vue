...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <SettingsLayout>
            ...
            <!-- Discord Connection -->
            <div class="flex flex-col space-y-6">
                <HeadingSmall title="Discord" description="Your Discord account is used for @mentions in notifications and to log in." />

                <div v-if="user.discord_id" class="flex items-center gap-3 rounded-lg border border-border p-4">
                ...
                <div v-else>
                    ...
                    <p class="mt-2 text-xs text-muted-foreground">Required for @mentions in notifications and to log in. Once connected it cannot be removed.</p>
                </div>
            </div>
